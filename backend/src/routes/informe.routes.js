...
import { getInformes, crearInforme, dejarObservacion, editarInforme, aprobarInforme, deleteInforme} from "../controllers/informe.controller.js";
...
router.delete("/:id", isTesorero, deleteInforme); // solo tesorero
